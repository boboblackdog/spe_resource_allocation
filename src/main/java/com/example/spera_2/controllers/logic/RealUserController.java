...
public class RealUserController {
    ...
    */
    public ResponseEntity<ResponseBody> loginUser(UserLoginRequest ulr, String Authentication, Employee emp, HttpServletRequest request) throws SQLException {
    ...
    */
    public ResponseEntity<ResponseBody> getUserProfile(UserProfileRequest upr, String Authentication, HttpServletRequest request, Employee emp) {
        Timestamp t1 = new Timestamp(new Date().getTime() + 25200000);
        HttpHeaders header = new HttpHeaders();
        header.add("x-trace-id", "TBD");
        ResponseBody rb;
